...
public class CartRestController {
    ...
    @PatchMapping(path = "cart/{cartId}", consumes = MediaType.APPLICATION_JSON_VALUE)
    public CartResponse patchCart(@PathVariable("cartId") Long cartId, @Valid @RequestBody CartRequest cartRequest) {
        try {
